...
namespace DoAnWebNangCao.Controllers
{
    ...
    {
        DanhMucModelDataContext _sanPhamContext = new DanhMucModelDataContext("Data Source=aegold;Initial Catalog=MobileShopDB;Integrated Security=True;TrustServerCertificate=True");
        // GET: DanhMucList
        ...
        public JsonResult GetListSanPham(int pageNumber, int pageSize)
        {
            ...
            var listSanPham = _sanPhamContext.Products
                .Join(_sanPhamContext.ProductCatalogues,  // Thực hiện JOIN với bảng ProductCatalogues
                      sp => sp.CatalogueID,  // Trường CatalogueID trong bảng Products
                      ...
                      (sp, pc) => new
                      {
                          ...
                          ImagePath = sp.Image_path // Nếu có trường ảnh
                      })
